...
public class WordLink {
    ...
    public void ReadfromFile(){
        ...
        try{
                ...
                while(filescanner.hasNextLine()){
                    ...
                    if(level1flag && !line.equalsIgnoreCase("1")&& !line.equalsIgnoreCase("2")){
                    ...
                    }else if(level2flag && !line.equalsIgnoreCase("2")&& !line.equalsIgnoreCase("1")){
                        String[]linearray2=line.split(" ");
                     
                      System.arraycopy(linearray2,0,this.Dictionarywordslevel2,level2counter,linearray2.length);
                    ...
                    /**
                     Array size exceeds
                     */
                   // System.out.println(level1counter+"--->"+level2counter);
                    if(level1counter >=this.Dictionarywordslevel1.length-2){
                      //  System.out.println("increase array 1");
                    ...
                    if(level2counter >=this.Dictionarywordslevel2.length-2){
                       // System.out.println("increase array 2");
                        this.Dictionarywordslevel2= this.IncreasesizeofArrays(this.Dictionarywordslevel2);
                    }
                }// end while
                this.Dictionarywordslevel1=this.resizeArrays(this.Dictionarywordslevel1, level1counter);
                Arrays.sort(this.Dictionarywordslevel1);
                this.Dictionarywordslevel2=this.resizeArrays(this.Dictionarywordslevel2, level2counter);
                Arrays.sort(this.Dictionarywordslevel2);
                       
                System.out.println("internal array has sorted the data");
               //System.out.println("size of arrays"+this.Dictionarywordslevel1.length);
        ...
        // this is resize the array to its contents size
     private String [] resizeArrays(String arg[],int indextoshrink){
         String []newArray= new String[indextoshrink];
         System.arraycopy(arg, 0, newArray, 0, indextoshrink);
      return newArray;           
     }   

 private void LoadArraysintoDictionary(){
     // load data from Dictionary words from level1 and then level2
     for(String data:this.Dictionarywordslevel1){
         //System.out.println(">>"+data);
         this.dictionary.insertWord(data, 1);
     
     }
     
     for(String data:this.Dictionarywordslevel2)
     this.dictionary.insertWord(data, 2);
 ...
 Dictionary dictionary;
    public void Menu(){
        ...
        // create Dictionary object and call the methods to invoke functionality
       this.dictionary =new Dictionary();
       this.LoadArraysintoDictionary();
           while(true){
            for(String menuitems: this.menuitems){
             ...
             char choice=cmdlinerader.charAt(0);
                ...
                switch(choice){
                    ...
                    case 'A':  // setting a difficult level
                        System.out.println("Set the difficulty level: ");
                        String levelstr=inputscanner.next();
                        ...
                        while(true){
                            try{
                                ...
                                if(level!=1 || level!=2){
                                     System.out.println("Please enter the right level either 1 or 2");
                                }else{
                         ...
                         break;
                    case 'B':   // display the dictionary
                        this.dictionary.DisplayDictionary();
                        
                         break;     
                    case 'C':   //  insert a word into dictionary 
                         break;
                    case 'D':   //  play the game
                         break;      
                    case 'E':
                           inputscanner.close();
                        System.exit(0);
            ...
            System.out.println("unexpected exception closing down program.."+e.toString());
            e.printStackTrace();
        }
